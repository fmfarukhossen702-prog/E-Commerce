...
const CardSkeleton = () => {
  return (
    <div>
      <div className="relative flex flex-col mt-6 text-gray-700 bg-white bg-clip-border rounded-xl w-67.5 animate-pulse">
        <div className="relative grid h-56 mx-2 mt-4 overflow-hidden text-gray-700 bg-gray-300 bg-clip-border rounded-xl place-items-center">
          <svg
